...
<!-- row -->
            ...
            <div class="card-body">
                ...
                <form action="{{ route('update_Student', 'test') }}" method="" autocomplete="off">
                    @method('')
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $Students->name }}" class="form-control" name="name_en" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="gender">{{('trip')}} : <span class="text-danger">*</span></label>
                                <select class="custom-select mr-sm-2" name="trip_id">
                                    <option selected disabled>{{('Choose')}}...</option>
                                    @foreach($trips as $trip)
                                        <option   {{ $trip->id == $Students->trip_id ? 'selected' : '' }} value="{{ $trip->id }}">{{ $trip->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
{{--                                    <option selected disabled>{{ 'Choose' }}...</option>--}}
                                    ...
                                    @for($year=$current_year-1; $year<=$current_year +1 ;$year++)
                                        <option {{ $year."-".$year +1== $Students->academic_year ? 'selected' : '' }}value="{{ $year."-".$year +1}}">{{ $year."-".$year +1 }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
