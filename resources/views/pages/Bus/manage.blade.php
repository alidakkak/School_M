...
@section('content')
                ...
                <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-flex justify-content-center align-items-center"> <a style="padding: 6px"  target="_blank" href="{{ route('Bus_show',$bus->id) }}" class="btn btn-danger btn-sm" role="button"
                                ...
                                <div  class="table-responsive" style="padding-bottom: 100px">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                                    ...
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item"
                                                               href="{{ route('trip_edit', $trip->id) }}"><i
                                                                        style="color: #83ae26" class="fa fa-edit"></i>&nbsp;
                                                                &nbsp; Edit</a>
                                                            {{--destroy--}}
                                                            <a class="dropdown-item"
                                                               data-toggle="modal" data-target="#delete_t{{ $trip->id }}"
                                                               ><i
                                                                        style="color: red"
                                                                        class="fa fa-trash"></i>&nbsp;
                                                                &nbsp; delete</a>
                                        ...
                                        @include('pages.Bus.trip.destroy')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
