...
Route::post('Result/show/store_update/{id}', [ResultController::class, 'ur_store'])
    ...
    Route::group(["middleware" => 'Dashboard:' . implode(',', $MO)], function ($router) {
        ...
        Route::get('bus/destroy/{id}', [BusController::class, 'destroy'])
            ->name('Bus_destroy');
        Route::get('bus/show/{id}', [BusController::class, 'show'])
            ->name('Bus_show');
...
//trip
        ...
        Route::post('trip/store/{id}', [TripController::class, 'store'])
            ->name('trip_store');
        Route::get('trip/edit/{id_trip}', [TripController::class, 'edit'])
            ->name('trip_edit');
        Route::post('trip/update/{id_trip}', [TripController::class, 'update'])
            ->name('trip_update');
        Route::get('trip/delete/{id_trip}', [TripController::class, 'destroy'])
            ->name('trip_delete');
